...
const SingleBlog = () => {
  return (
    <section className="mt-32">
      {/* Single Article */}
      <div className="px-5 md:px-8 xl:px-13 max-w-5xl mx-auto">
        <article>
          <p className="text-responsive text-primary-blue-dark font-semibold uppercase tracking-wide mb-5">
          ...
          <div className="flex gap-5 justify-between items-center mb-5">
            <p className="text-primary-blue-dark tracking-wide">
          ...
          <p className="text-gray-900 tracking-wide leading-relaxed text-justify">
