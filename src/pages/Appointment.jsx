        ...
        <div className="flex flex-col lg:flex-row gap-5 md:gap-8 xl:gap-13 items-center justify-center">
          <div className="w-full max-w-2xl lg:w-1/2">
            <div className="mb-5">
              ...
              <p className="text-responsive-text text-gray-900 tracking-wide">
          ...
          <div className="w-fit p-8 text-primary-white bg-primary-blue-dark flex flex-col items-center gap-5 lg:gap-8 rounded">
            <p className="text-responsive-heading font-medium tracking-wide text-center">
              Schedule Hours
            </p>
            <div className="flex gap-5 lg:gap-8 text-responsive-text">
            ...
            <div className="flex items-center gap-5">
              ...
              <div>
                <p className="text-responsive-text xl:text-lg mb-1">
                  Emergency
                </p>
                <a
                  href="tel:+977 980-1222339"
                  className="block text-responsive-text xl:text-lg"
                >
                  9801222339
                </a>
              </div>
